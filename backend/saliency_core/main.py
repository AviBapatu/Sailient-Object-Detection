...
image = cv2.imread("./Test Images/simple2_400.jpg")
if image is None:
...
for s in scales:
    saliency_s = compute_saliency(image, s)
...
cv2.imwrite("saliency.png", (saliency_final * 255).astype(np.uint8))
...
# print("Saliency map shape:", saliency_final.shape)